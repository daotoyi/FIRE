...
lastmod = 2022-03-27T15:53:04+08:00
tags = ["RayDalio"]
categories = ["Archive"]
draft = false
+++
...
## 01 货币与信用永恒与普世的基本原理 {#01-货币与信用永恒与普世的基本原理}
...
### 1.无债务或低债务和 "硬通货 " {#1-dot-无债务或低债务和-硬通货}
...
### 2.对 "硬通货"的债权（又称“凭证”或 "纸币"） {#2-dot-对-硬通货-的债权-又称-凭证-或-纸币}
...
### 4. 债务危机、违约和货币贬值 {#4-dot-债务危机-违约和货币贬值}
